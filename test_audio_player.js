...
P[0].connect(G[0]);
P[0].load({src: '../soundtouchjs/5.mp3', bpm: P[0].default_bpm});
...
P[1].connect(G[1]);
P[1].load({src: '../soundtouchjs/4.mp3', bpm: P[1].default_bpm});
...
// P[2].connect(G[2]);
// P[2].load({src: '../soundtouchjs/3.mp3', bpm: P[2].default_bpm});
...
// P[3].connect(G[3]);
// P[3].load({src: '../soundtouchjs/1.mp3', bpm: P[3].default_bpm});
...
// P[4].connect(G[4]);
// P[4].load({src: '../soundtouchjs/2.mp3', bpm: P[4].default_bpm});
...
// P[5].connect(G[5]);
// P[5].load({src: '../soundtouchjs/6.mp3', bpm: P[5].default_bpm});
